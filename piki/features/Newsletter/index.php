...
function pikiform_newsletter_settings(){
    return array(
        ...
        'success_message' => '<i class="icon icon-check"></i><span class="text">Muito Obrigado por assinar nossa Newsletter!</span>',
...
function pikiform_newsletter_fields(){
    return [
        ...
        'receive_clipping' => [
            ...
            'ftype' => 'boolean',
            'label' => 'Quero receber o clipping diário de notícias sobre desmatamento',
        ],
        'receive_news' => [
            'machine_name' => 'receive_news',
            'ftype' => 'boolean',
            'label' => 'Concordo em receber novidades sobre o PlenaMata e participar de pesquisas de opinião a respeito da plataforma.',
            'require' => true,
        ],
    ];
}
